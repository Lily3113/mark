  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="pt-32 pb-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        ...
        >
          <FloatingTape color="blue" className="-left-10 -bottom-14" rotation={155} size="lg" />
          ...
          />
          <FloatingTape color="rose" className="-right-10 -top-16 z-0" rotation={310} size="lg" />
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <motion.div
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.6 }}
          className="relative bg-navy rounded-2xl p-12 overflow-hidden"
        >
          ...
          <div className="relative z-10 max-w-md">
            ...
            <motion.h2
              ...
              className="font-display text-3xl font-semibold text-primary-foreground mb-6"
            >
